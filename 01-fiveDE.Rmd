...
# Components of an Index {#components}

## Dimensions of Empowerment in Agriculture {#fiveDE}

### Computing the 5DE subindexes
* Model: [@Alkire2011]
...
### Plot the Results
```{r uncensored-fig, fig.cap='Absolute and relative contribution of Indicator to disempowerment', out.width='80%', fig.asp=.75, fig.align='center'}
library(tidyverse)
library(viridis)
...
### Summary
* **Our goal**: See Chapter \@ref(components)
